    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">Range List</h4>
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Range List</li>
        ...
        columns: [{
            ...
            },
            {
                ...
                data: (function (row) {
                    ...
                    return gridjs.html(`<span>${row.min}</span>`);
            ...
            },
            {
                ...
                data: (function (row) {
                    ...
                    return gridjs.html(`<span>${row.max}</span>`);
            ...
            },
            {
                ...
                data: (function (row) {
                    ...
                    return gridjs.html(`<span>${row.courses}</span>`);
            ...
            },
            {
                ...
                data: (function (row) {
                    ...
                    return gridjs.html(`<span>${row.workshops}</span>`);
