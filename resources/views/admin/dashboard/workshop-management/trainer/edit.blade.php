    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">Edit Trainer  </h4>
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('workshop-management.trainer.index')}}">List Trainers</a></li>
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('workshop-management.trainer.update', $trainer->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="first_name" value="{{old('first_name') ? old('first_name') : $trainer->first_name}}" class="form-control" id="first_name" placeholder="Enter first name">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="last_name" value="{{old('last_name') ? old('last_name') : $trainer->last_name}}" class="form-control" id="last_name" placeholder="Enter last name">
                        ...
                        <div class="row mt-3 mb-3">
                            ...
                            <div class="col-1">
                                ...
                                <img class="img-fluid" src="{{$trainer->getAbsoluteProfileImagePath()}}" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="about" name="about">{!! old('about') ? old('about') : $trainer->about !!}</textarea>
    ...
    @if(session('success'))
        ...
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Well done !</h4>' +
                '<p class="text-muted mx-4 mb-0">Trainer is Updated successfully!</p>' +
                '</div>' +
                '</div>',
