    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0"> Workshop : {{$workshop->name}}  </h4>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('workshop-management.batch.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="limit" value="" class="form-control" id="limit" value="{{old('limit')}}" placeholder="Enter registration limit">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col mb-3">
                                ...
                                <div class="input-group date" id="start_date" data-target-input="nearest">
                                    ...
                                    <input type="text" class="form-control" name="start_date" data-provider="flatpickr" value="{{old('start_date') ? date('d M, Y', strtotime(old('start_date'))) : ''}}" data-date-format="d M, Y" >
                            ...
                            <div class="col mb-3">
                                ...
                                <div class="input-group date" id="end_date" data-target-input="nearest">
                                    ...
                                    <input type="text" class="form-control" name="end_date" data-provider="flatpickr" value="{{old('end_date') ? date('d M, Y', strtotime(old('end_date'))) : ''}}" data-date-format="d M, Y" >
    ...
    @if(session('success'))
        ...
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Well done !</h4>' +
                '<p class="text-muted mx-4 mb-0">New Batch for this workshop is created successfully!</p>' +
                '</div>' +
                '</div>',
