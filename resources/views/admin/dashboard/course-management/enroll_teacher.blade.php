    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">Enroll Teacher <span class="text-muted">(Course Name: {{ $course->title }})</span></h4>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('course-management.course.enroll-teacher', $course_id)}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <label for="choices-multiple-remove-button" class="form-label">Email Address*</label>

                                    <p class="text-muted">Enter the email addresses of teachers for enrollment</p>

                                    <select class="form-control" id="choices-multiple-remove-button" data-choices data-choices-removeItem name="teacher_ids[]" multiple>
                                    ...
                                    @error('teacher_ids') <span class="text-danger d-block mt-2">{{ $message }}</span> @enderror
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-flat"><i class="fas fa-arrow-alt-circle-right"></i> Enroll</button>
