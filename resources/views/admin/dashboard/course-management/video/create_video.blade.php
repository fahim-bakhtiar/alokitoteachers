        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('course-management.course.video.create', $course->id)}}" enctype=multipart/form-data>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="url" value="{{old('url')}}"  class="form-control" id="url" placeholder="Enter Video URL" >
...
<script>
    ...
    Swal.fire({
        html: '<div class="mt-3">' +
            '<lord-icon src="https://cdn.lordicon.com/tdxypxgp.json" trigger="loop" colors="primary:#0ab39c,secondary:#405189" style="width:120px;height:120px"></lord-icon>' +
            '<div class="mt-4 pt-2 fs-15">' +
            '<h4>Success!</h4>' +
            '<p class="text-muted mx-4 mb-0">' + message + '</p>' +
            '</div>' +
