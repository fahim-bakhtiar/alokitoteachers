            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('course-management.course.list')}}">List Courses</a></li>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('course-management.course.edit', $course->id)}}" enctype=multipart/form-data>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{old('title') ? old('title') : $course->title}}" class="form-control" id="title" placeholder="Enter title">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" value="{{old('price') ? old('price') : $course->price}}"  class="form-control" id="price" placeholder="Enter price" >
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sale_price" value="{{old('sale_price') ? old('sale_price') : $course->sale_price}}"  class="form-control" id="sale_price" placeholder="Enter Sale price" >
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="certificate_price" value="{{old('certificate_price') ? old('certificate_price') : $course->certificate_price}}"  class="form-control" id="certificate_price" placeholder="Enter Certificate price" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="details" name="details">{!! old('details') ? old('details') : $course->details !!}</textarea>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="learning_objective" id="learning_objective">{!! old('learning_objective') ? old('learning_objective') : $course->learning_objective !!}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-1">
                                ...
                                <img class="img-fluid" src="{{$course->getAbsoluteProfileImagePath()}}" alt="">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="preview_video" value="{{old('preview_video') ? old('preview_video') : $course->preview_video}}" class="form-control" id="title" placeholder="Preview Video URL">
                            ...
                            <div class="col mb-3">
                                ...
                                <label for="categories" class="form-label text-muted">Category</label>
                                ...
                                <select class="form-control" id="categories" data-choices data-choices-removeItem name="categories[]" multiple>
                                    ...
                                    @foreach($categories as $category)
                                        ...
                                        <option value=@json(['id' => $category->id, 'type' => $category->type]) {{ in_array($category->id, $course->categories_array()) ? 'selected' : '' }}>{{$category->name}}</option>
                            ...
                            <div class="col mb-3">
                                ...
                                <select class="form-control" id="advisors" data-choices data-choices-removeItem name="advisors[]" multiple required>
                                    ...
                                    @foreach($faculties as $faculty)
                                        ...
                                        <option value={{$faculty->id}} {{ in_array($faculty->id, $current_advisors) ? 'selected' : '' }}>
                                            {{$faculty->fullname()}}
                                        </option>
                            ...
                            <div class="col mb-3">
                                ...
                                <select class="form-control" id="designers" data-choices data-choices-removeItem name="designers[]" multiple required>
                                    ...
                                    @foreach($faculties as $faculty)
                                        ...
                                        <option value={{$faculty->id}} {{ in_array($faculty->id, $current_designers) ? 'selected' : '' }}>{{$faculty->fullname()}}</option>
                            ...
                            <div class="col mb-3">
                                ...
                                <select class="form-control" id="facilitators" data-choices data-choices-removeItem name="facilitators[]" multiple required>
                                    ...
                                    @foreach($faculties as $faculty)
                                        ...
                                        <option value={{$faculty->id}} {{ in_array($faculty->id, $current_facilitators) ? 'selected' : '' }}>{{$faculty->fullname()}}</option>
    ...
    @if(session('success'))
        ...
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Well done !</h4>' +
                '<p class="text-muted mx-4 mb-0">New Course is updated successfully!</p>' +
                '</div>' +
                '</div>',
