    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">Create Teacher  </h4>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('user-management.teacher.create')}}" enctype=multipart/form-data>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12"> <h4><i class="fas fa-id-card mr-2"></i> Basic Informations</h4></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name" value="{{old('first_name')}}" class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" id="" placeholder="First name">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_name" value="{{old('last_name')}}" class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" id="" placeholder="Last name">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email" value="{{old('email')}}"  class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" id="exampleInputEmail1" placeholder="Enter email" >
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="phone" value="{{old('phone')}}"  class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" id="exampleInputEmail1" placeholder="Enter phone" >
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group date" id="dob" data-target-input="nearest">
                                        ...
                                        <input type="text" class="form-control" name="dob" value="{{old('dob') ? date('d M, Y', strtotime(old('dob'))): ''}}" data-provider="flatpickr" data-date-format="d M, Y">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="full_address" value="{{old('full_address')}}" class="form-control" id="" placeholder="Full Address">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="username" value="{{old('username')}}"  class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" id="exampleInputEmail1" placeholder="atuser13" >
                            ...
                            <div class="row">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="school" value="{{old('school')}}"  class="form-control" id="exampleInputEmail1" placeholder="School Name" >
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="school_address" value="{{old('school_address')}}"  class="form-control" id="exampleInputEmail1" placeholder="School Address" >
                                ...
                                <div class="col mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="experience">
                                            ...
                                            <option value="0" {{ old('experience') == '0' ? 'selected' : '' }} > < 1 Year</option>
    ...
    @if(session('success'))
        ...
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Well done !</h4>' +
                '<p class="text-muted mx-4 mb-0">New Teacher is created successfully!</p>' +
                '</div>' +
                '</div>',
