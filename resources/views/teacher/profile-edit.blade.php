                                    ...
                                    <div class="avatar-upload d-flex align-items-center">
                                        <div class="avatar-preview">
                                            <div id="imagePreview"
                                                ...
                                                @else
                                                style="background-image: url({{asset_url('storage/images/teachers')}}/{{$logged_in_teacher->dp}});"
                                                @endif
                                            ></div>
                                        </div>
                                        <div class="avatar-edit flex">
                                            <div>
                                            ...
                                            <input type="hidden" name="upload_type" value="file" id="">
                                            <div class="remove-image d-flex align-items-center" style="background-color:white; border:none; border:1px solid #F29C1F;border-radius:10px;text-transform:capitalize">
                                    ...
                                    <div class="form-group mb-4 @error('dob') ? form-error : '' @enderror">
                                        ...
                                        <div class="input-group date" id="dob" data-target-input="nearest">
                                            ...
                                            <input type="text" name="dob" class="form-control datetimepicker-input"
                                                @if(old('dob'))
                                                    value="{{old('dob')}}" 
                                                @elseif(!$logged_in_teacher->dob)
                                                    value=""    
                                                @else 
                                                    value="{{date('m/d/Y', strtotime($logged_in_teacher->dob))}}" 
                                                @endif
                                                data-target="#dob">
                            ...
                            <div class="col-lg-6">
                                <div class="edit-card">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-lg-12 mb-30 mb-lg-0">
                                            <select name="school_district_id" id="school_district" title="District" class="selectpicker form-control">
                                                @foreach(all_districts() as $district)
                                                    <option value="{{$district->id}}" @if(old('school_district_id') == $district->id) selected @elseif($logged_in_teacher->check_for_null_and_get_school_district_id() == $district->id) selected @endif>{{$district->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 mb-30 mb-lg-0">
                                            <select name="grades_teaching[]" id="user_class" title="Grades you teach" class="selectpicker form-control" multiple>
                                                @foreach(all_grade_levels() as $grade)
                                                    <option value="{{$grade->id}}" @if(in_array($grade->id, $logged_in_teacher->grades_array())) selected @endif>{{$grade->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-lg-6">
