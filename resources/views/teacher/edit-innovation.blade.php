                ...
                <div class="monthly-summery">
                    <div class="profile-header d-flex align-items-center mb-40">
                        <div class="d-flex align-items-center">
                            ...
                            <h3 class="fw-400 mb-0">EDIT INNOVATION</h3>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="{{ route('teacher.innovation.update', $innovation->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mb-4 @error('title') ? form-error : '' @enderror">
                                            ...
                                            <input id="title" type="text" name="title" class="form-control"  value="{{ old('title') ? old('title') : $innovation->title }}" placeholder="Innovation Title"/>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mb-4 @error('description') ? form-error : '' @enderror">
                                            ...
                                            <textarea class="form-control" name="description" id="description" placeholder="Innovation Description">
                                                {{ old('description') ? old('description') : $innovation->description }}
                                            </textarea>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mb-4 @error('price') ? form-error : '' @enderror">
                                            ...
                                            <input id="price" type="number" name="price" class="form-control"  value="{{ old('price') ? old('price') : $innovation->price }}" placeholder="Innovation price"/>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <img class="img-responsive mb-2" style="max-width: 700px;" src="{{ $innovation->getAbsoluteThumbnailPath() }}" alt="">
