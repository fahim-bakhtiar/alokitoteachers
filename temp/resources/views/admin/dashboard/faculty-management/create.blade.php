    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <h4 class="mb-sm-0">Create Activist  </h4>
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Create Activist</li>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('faculty-management.faculty.create')}}" enctype=multipart/form-data>
    ...
    @if(session('success'))
        ...
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Success !</h4>' +
                '<p class="text-muted mx-4 mb-0">New Activist is created successfully!</p>' +
                '</div>' +
                '</div>',
