        ...
        <div class="col-12">
            ...
            <div class="card card-info">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title">Add Testimonial for Workshop - {{ $workshop->name }}</h3>

                </div>

                <form method="POST" action="{{ route('workshop-management.workshop-testimonial.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="profession" value="{{old('profession')}}" class="form-control" id="profession" placeholder="Enter profession">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="institution" value="{{old('institution')}}" class="form-control" id="institution" placeholder="Enter institution">
