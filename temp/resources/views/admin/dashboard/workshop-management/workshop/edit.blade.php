            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('workshop-management.workshop.index')}}">List Workshops</a></li>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('workshop-management.workshop.update', $workshop->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{old('name') ? old('name') : $workshop->name }}" class="form-control" id="name" placeholder="Enter name">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" value="{{old('price') ? old('price') : $workshop->price }}" class="form-control" id="price" placeholder="Enter price">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sale_price" value="{{old('sale_price') ? old('sale_price') : $workshop->sale_price }}" class="form-control" id="sale_price" placeholder="Enter sale price">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control select2bs4" style="width: 100%;">
                                        ...
                                        <option value="Online" @if(old('type') == 'Online' || $workshop->type == 'Online') selected @endif>Online</option>
                                        <option value="Offline" @if(old('type') == 'Offline' || $workshop->type == 'Offline') selected @endif>Offline</option>
                                        <option value="Blended" @if(old('type') == 'Blended' || $workshop->type == 'Blended') selected @endif>Blended</option>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="preview_video_url" value="{{old('preview_video_url') ? old('preview_video_url') : $workshop->preview_video_url }}" class="form-control" id="preview_video_url" placeholder="Enter preview video url">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description">{!!old('description') ? old('description') : $workshop->description !!}</textarea>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-1">
                                ...
                                <label for="exampleInputFile" style="visibility:hidden">Thumbnail</label>

                                <img class="img-fluid" src="{{$workshop->getAbsoluteThumbnailPath()}}" alt="">
                        ...
                        <div class="row mt-3">
                                ...
                                <select class="form-control" id="trainers" data-choices data-choices-removeItem name="trainers[]" multiple>
                                    ...
                                    @foreach($trainers as $trainer)
                                        ...
                                        <option value="{{ $trainer->id }}" 
                                                @if(in_array($trainer->id, $trainers_in_this_workshop)) selected @endif>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="duration" value="{{old('duration') ? old('duration') : $workshop->duration }}" class="form-control" id="duration" placeholder="Enter duration">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_credit_hours" value="{{old('total_credit_hours') ? old('total_credit_hours') : $workshop->total_credit_hours }}" class="form-control" id="total_credit_hours" placeholder="Enter total credit hours">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col mb-3">
                                ...
                                <div class="input-group date" id="start_date" data-target-input="nearest">
                                    ...
                                    <input type="text" class="form-control" name="start_date" value="{{old('start_date') ? date('d M, Y', strtotime(old('start_date'))) : date('d M, Y', strtotime($workshop->start_date))}}" data-provider="flatpickr" data-date-format="d M, Y" >
                            ...
                            <div class="col mb-3">
                                ...
                                <div class="input-group date" id="end_date" data-target-input="nearest">
                                    ...
                                    <input type="text" class="form-control" name="end_date" value="{{old('end_date') ? date('d M, Y', strtotime(old('end_date'))) : date('d M, Y', strtotime($workshop->end_date))}}" data-provider="flatpickr" data-date-format="d M, Y" >
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="learning_outcomes" name="learning_outcomes">{!!old('learning_outcomes') ? old('learning_outcomes') : $workshop->learning_outcomes !!}</textarea>
                    ...
                    <div class="card-footer">
                        ...
                        <button type="submit" class="btn btn-primary btn-flat">
                            <i class="fas fa-arrow-alt-circle-right"></i> Update
                        </button>
    ...
    @if(session('success'))
        ...
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Well done !</h4>' +
                '<p class="text-muted mx-4 mb-0">Workshop is updated successfully!</p>' +
                '</div>' +
                '</div>',
