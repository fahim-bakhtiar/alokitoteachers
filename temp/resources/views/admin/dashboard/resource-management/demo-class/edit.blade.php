        ...
        <div class="col-12">
            ...
            <div class="card card-info">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title">Edit Demo Class</h3>

                </div>

                <form method="POST" action="{{ route('resource-management.demo-class.update', $demo_class->id) }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{ old('title') ? old('title') : $demo_class->title }}" class="form-control" id="title" placeholder="Enter title">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="class" style="width: 100%;">
                                        ...
                                        @foreach($grades as $grade)
                                            ...
                                            <option value="{{ $grade->id }}" {{ (old('class') ? (old('class') == $grade->id ? "selected" : "") : ($grade->id == $demo_class->class ? "selected" : "" )) }}>{{ $grade->name }}</option>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" name="subject" style="width: 100%;">
                                        ...
                                        @foreach($subjects as $subject)
                                            ...
                                            <option value="{{ $subject->id }}" {{ (old('subject') ? (old('subject') == $subject->id ? "selected" : "") : ($subject->id == $demo_class->subject ? "selected" : "" )) }}>{{ $subject->name }}</option>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="video_url" value="{{ old('video_url') ? old('video_url') : $demo_class->video_url }}" class="form-control" id="video_url" placeholder="Enter video url">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="duration" value="{{ old('duration') ? old('duration') : $demo_class->duration }}" class="form-control" id="duration" placeholder="Enter duration">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" value="{{ old('price') ? old('price') : $demo_class->price }}" class="form-control" id="price" placeholder="Enter price">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sale_price" value="{{ old('sale_price') ? old('sale_price') : $demo_class->sale_price }}" class="form-control" id="sale_price" placeholder="Enter sale price">
