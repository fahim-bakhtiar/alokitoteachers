    ...
    <div class="row">
        ...
        <div class="col-12 mb-4">
            ...
            <div class="p-3" style="background-color:#e1e1e1">
                ...
                <a href="{{route('resource-management.demo-class.create')}}" class="btn btn-primary btn-lg"> <i class="fas fa-plus-circle mr-1"></i> Create</a>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title">Demo Classes</h3>
                ...
                <div class="card-body">
                    ...
                    <table id="example1" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            @foreach($demo_classes as $demo_class)
                                <tr>
                                    
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $demo_class->title }}</td>
                                    <td>{{ $demo_class->classCategory->name }}</td>
                                    <td>{{ $demo_class->subjectCategory->name }}</td>
                                    <td>{{ $demo_class->video_url }}</td>
                                    <td>{{ $demo_class->duration }}</td>
                                    <td>{{ $demo_class->price }}</td>
                                    <td>{{ $demo_class->sale_price }}</td>
                                    <td>
                                        @if($demo_class->status == "active")
                                            <span class="text-success text-bold">{{ $demo_class->status }}</span>
                                        @else
                                            <span class="text-danger text-bold">{{ $demo_class->status }}</span>
                                        @endif
                                    </td>
                                    ...
                                    <td style="width: 5%;">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                <a class="dropdown-item" href="{{ route('resource-management.demo-class.edit', $demo_class->id) }}">Edit</a>
                                                <a class="dropdown-item" href="{{ route('resource-management.demo-class.change-status', $demo_class->id) }}">Change Status</a>
                                            </div>
                                        </div>
                                    </td>
