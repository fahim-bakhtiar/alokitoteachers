            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('package-management.list')}}">List Packages</a></li>
        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('package-management.edit', $package->id)}}" enctype=multipart/form-data>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="title" value="{{old('title') ? old('title') : $package->title }}" class="form-control" id="title" placeholder="Enter title">
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" value="{{old('price') ? old('price') : $package->price}}"  class="form-control" id="price" placeholder="Enter price" >
                            ...
                            <div class="col-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="duration" value="{{old('duration') ? old('duration') : $package->duration}}"  class="form-control" id="duration" placeholder="Enter duration" >
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="max_course" value="{{old('max_course') ? old('max_course') : $package->max_course}}"  class="form-control" id="max_course" placeholder="Enter Maximum Number of Courses" >
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="max_resource" value="{{old('max_resource') ? old('max_resource') : $package->max_resource}}"  class="form-control" id="max_resource" placeholder="Enter Maximum Number of Resources" >
                            ...
                            <div class="col-4">
                                ...
                                <input type="number" name="max_workshop" value="{{old('max_workshop') ? old('max_workshop') : $package->max_workshop}}"  class="form-control" id="max_workshop" placeholder="Enter Maximum Number of Workshops" >
                        ...
                        <div class="row">
                            ...
                            <div class="col-1">
                                <img class="img-fluid" src="{{$package->getAbsoluteProfileImagePath()}}" alt="">
                            </div>
    ...
    @if(session('success'))
        ...
        Swal.fire({
            html: '<div class="mt-3">' +
                ...
                '<h4>Well done !</h4>' +
                '<p class="text-muted mx-4 mb-0">Package is updated successfully!</p>' +
                '</div>' +
                '</div>',
