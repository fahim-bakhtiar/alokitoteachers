        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <div class="card-header text-right bg-gray-dark color-palette">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <h5 class="text-left pl-3">Course: {{$quiz->course->title}}</h5>
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('course-management.course.quiz.edit', $quiz->id)}}" enctype=multipart/form-data>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{old('title') ? old('title') : $quiz->title}}" class="form-control" id="title" placeholder="Enter title">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sequence" value="{{old('sequence') ? old('sequence') : $quiz->sequence}}"  class="form-control" id="sequence" placeholder="Enter sequence number" >
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="detail" name="detail">{{old('detail') ? old('detail') : $quiz->detail}}</textarea>
