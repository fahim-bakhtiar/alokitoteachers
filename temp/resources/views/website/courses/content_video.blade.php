            ...
            <div class="col-lg-7 offset-lg-1">
                <div class="course-nav d-flex justify-content-between">
                    ...
                    <div class="course_page_next_box text-end">
                        <form id="course_video_watched" action="{{route('course.teacher.course_video_watched')}}" method="POST" style="display: none;">
                            @csrf
                        ...
                        <a href="" class="btn-default btn-secondary btn-150" onclick="event.preventDefault();document.getElementById('course_video_watched').submit();">
                            Next
                ...
                <h2 class="fw-400" style="line-height:1.8">{{$course_sequence[$desired_sequence]->title}}</h2>
                ...
                <div class="iframe-container mb-4">
                    <iframe class="responsive-iframe" src="{{$course_sequence[$desired_sequence]->url}}" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>
                </div>
