        ...
        <div class="row align-items-center flex-column-reverse flex-lg-row">
            ...
            <div class="col-lg-6">
                <div class="banner-content">
                    ...
                    <a href="login.html" class="btn btn-default">Join Alokito Teachers<i class="ri-arrow-right-s-line"></i></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="course-item">
                            <div class="course-thumb">
                                <a href="course-single.html"><img class="course-image" src="{{$course->getAbsoluteProfileImagePath()}}" alt="course"></a>
                            ...
                            <div class="course-content">
                                ...
                                <a href="course-single.html" class="course-name">{{$course->title}}</a>
            ...
            <div class="col-md-5 offset-md-1">
                <div class="counter d-flex align-items-center">
                    ...
                    <div class="counter-content">
                        <h1 class="counter-number">১৩,৫২২</h1>
                        <p class="counter-title">টিচার্স ট্রেইন্ড</p>
                    </div>
                </div>
                <div class="counter d-flex align-items-center">
                    <div class="counter-icon">
                    ...
                    <div class="counter-content">
                        <h1 class="counter-number">৪০৫,৬৬০</h1>
                        <p class="counter-title">চেইঞ্জমেকার ডেভেলপড</p>
                    </div>
                </div>
                <div class="counter d-flex align-items-center">
                    <div class="counter-icon">
                    ...
                    <div class="counter-content">
                        <h1 class="counter-number">৫০+</h1>
                        <p class="counter-title">ওয়ার্কশপ ও বানানো কোর্স</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="workshop-content">
                    <h2>ওয়ার্কশপ ও বানানো কোর্স</h2>
                    <p>ওয়ার্কশপের ডিটেইলস। সংজ্ঞার চাইতে কীভাবে হেল্প করবে সেটা জানালে ভালো। ফ্রিকোয়েন্টলী করা হয় এটা
                        জানানোও ভালো। দুটি বাক্যের বেশি না </p>
...
<section class="why-choose-us">
    <div class="container d-flex justify-content-center">
        <div class="col-lg-10">
            <h2 class="section-title">কেন জয়েন করবেন আলোকিত টিচার্সে ?</h2>
            <p class="mb-40">আমরা শিক্ষকদের শেখার, আয় করার এবং নিজেদের বিকশিত করার সুযোগ প্রদান করি</p>
            <div class="row">
                <div class="col-md-4">
...
<section class="leader-board">
    <div class="container ">
        <h2 class="section-title d-flex align-items-center">শিক্ষকদের লিডারবোর্ড <i class="ri-question-line"></i></h2>
        <p class="mb-40">প্রত্যেকোটি ফিচারের পেইজে একটি করে বাটন থাকবে, সেগুলো ক্লিক করলে রিডাইরেক্ট করে রেস্পেক্টিভ
            ফিচারের টেবিলে (এই টেবিলেই) নিয়ে আসবে।</p>
        <div class="leader-board-table">
            <div class="leader-board-table-header">
                <h3>কোর্স লিডারবোর্ড</h3>
                <select name="" id="" class="form-select">
                    <option value="">কোর্স লিডারবোর্ড</option>
                    <option value="">ওয়ার্কশপ লিডারবোর্ড</option>
                    <option value="">ইনোভেশন লিডারবোর্ড</option>
                    <option value="">ওভারঅল লিডারবোর্ড</option>
                </select>
            </div>
...
<section class="testimonial-section">
    <div class="container">
        <h2 class="section-title">শিক্ষকদের মন্তব্য</h2>
...
<section class="partner-section">
    <div class="container">
        <h2 class="section-title">যেসব স্কুলের সাথে আমরা কাজ করি</h2>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-5">
                <div class="workshop-content">
                    <h2>চাকরি খুঁজছেন?</h2>
                    <p>এগুলো প্লেসহোল্ডার টেক্সট, যাদের কোন মানে নেই এবং চূড়ান্ত ডিজাইনে এরা থাকবে না।
                        বাটনে লেখা খুঁজুন। লগইন করা থাকলে জব পেইজে নিয়ে যাবে; না থাকলে সাইনআপ/লগইন পেইজে নিবে </p>
                    <a href="" class="btn-default">আরও দেখুন <i class="ri-arrow-right-s-line"></i></a>
                </div>
            </div>
...
<section class="partner-section style-two">
    <div class="container">
        <h2 class="section-title">আমাদের পাটনার্স</h2>
